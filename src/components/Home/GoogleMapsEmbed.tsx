        ...
        return (
            <>
                <div className='relative flex min-h-screen flex-col border-t border-white'>
                    ...
                    >
                        <div className='m-auto w-full break-words text-lg'>
                            <p className='p-3'>
                                The Bolivar Peninsula is located across the
                                ferry from Galveston. When you come across the
                                bay to the peninsula via ferry boat, the
                                landscape changes from urban port to small beach
                                town charm.
                            </p>
                            <p className='p-3'>
                                There are local amenities and restaurants and a
                                few well stocked stores. For local events,
                                activities, and all kinds of information, visit{' '}
                                <a
