        ...
        <>
            ...
            <div className='m-6 w-3/4 self-center rounded-lg bg-white p-5 text-black shadow-3xl'>
                ...
                <p className='mb-5 rounded-2xl p-4'>
                    {`Thanks for trusting CheersBeaches.House
                    ('3841 Biscayne Beach', 'Cheers Beaches', 'we', 'us', 'our')
                    with your personal information! We take our responsibility
                    to you very seriously, and so this Privacy Statement
                    describes how we handle your data. This Privacy Statement
                    applies to all websites we own and operate and to all
                    services we provide (collectively, the 'Services'). So
                    Please Read This Privacy  Statement Carefully. By using the
                    Services, you are expressly and voluntarily accepting the
                    terms and conditions of this Privacy Statement and our Terms
                    of Service, which include allowing us to process information
                    about you. Under this Privacy Statement, we are the data
                    controller responsible for processing your personal
                    information. Our contact information appears at the end of
                ...
                <p className='mb-5 rounded-2xl p-4 '>
                    ...
                    recognize you and make your next visit easier and the Website more useful to you.`}
                </p>
